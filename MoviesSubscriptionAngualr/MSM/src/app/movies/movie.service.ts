...
import { IMovieResponse, IMoviesNamesResponse, IMoviesResponse } from './movie';
...
export class MovieService {
  ...
  createMovie(movie: IMovieResponse): Observable<IMovieResponse> {
     return this.http.post<IMovieResponse>(this.movieUrl + "/addMovie", movie.movieData)
      .pipe(
  ...
  updateMovie(movie: IMovieResponse): Observable<IMovieResponse> {
    return this.http.put<IMovieResponse>(this.movieUrl + "/updateMovie" + `/${movie.movieData._id}`, movie.movieData,)
      .pipe(
        tap(() => console.log('updateMovie: ' + movie.movieData._id)),
