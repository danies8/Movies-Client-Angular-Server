...
import { IMemberResponse, IMembersResponse, ISubscribeNewMovieResponse } from './member';
...
export class MemberService {
  ...
  createMember(member: IMemberResponse): Observable<IMemberResponse> {
    return this.http.post<IMemberResponse>(this.memberUrl + "/addMember", member.member)
      .pipe(
  ...
  updateMember(member: IMemberResponse): Observable<IMemberResponse> {
   return this.http.put<IMemberResponse>(this.memberUrl + "/updateMember" + `/${member.member._id}`,member.member)
      .pipe(
        tap(() => console.log('updateMember: ' + member.member._id)),
